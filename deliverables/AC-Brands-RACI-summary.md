...
## Erin holds packaging and artwork; Danielle holds brand

Erin is the lead technical authority on packaging and artwork, so packaging development, artwork execution and the label artwork archive answer to her, with Jan executing under her. Perrine consults where formula contact or compatibility is in play. That splits packaging from formulation properly — they had been collapsed into one accountability before.

Danielle picks up brand guideline custody and campaign direction. Campaign direction was missing from the matrix entirely, which is why the President had almost no Marketing presence; she now appears on all nine Marketing rows and all three Creative rows rather than only receiving finished work. Ayesha keeps sole accountability for brand-line moves and is consulted on the six rows where the brand carries her name — brand guidelines, creative direction, campaign direction, claim substantiation, retailer attestations and packaging.

Worth naming plainly: Erin, Jan and Perrine are all contractors, and between them they hold accountability for eleven activities. On creative direction Erin is both accountable and responsible with no internal counterpart. Neither specialist job description covers creative or formulation authority, so the two hires do not close that.
