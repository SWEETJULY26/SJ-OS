...
**Not yet done:** re-run the two fireflies-asana-bridge evals against the rescoped skill to confirm the token reduction actually lands and nothing regressed on correctness.
