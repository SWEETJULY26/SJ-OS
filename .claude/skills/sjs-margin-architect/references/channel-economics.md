...
1. **Reformulate** — reduce landed COGS. Nicole + sourcing.
2. **Reprice** — lift MSRP into band. Alvin + Soraya.
3. **Restrict** — tag SKU as DTC/marketplace-only. Alvin + commercial.
4. **Retire** — discontinue. Alvin + Nicole + Soraya.
