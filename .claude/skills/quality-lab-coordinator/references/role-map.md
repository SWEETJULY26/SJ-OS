...
4. If the Quality Gate or Technical Advisor role-holder changes, update capa-coordinator, batch-lifecycle-tracker, complaint-and-event-handler, and (post-v5.5) quality-manager role maps at the same time — System B skills share these roles.
