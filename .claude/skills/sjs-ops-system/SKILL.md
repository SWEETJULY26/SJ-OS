...
name: sjs-ops-system
description: >
  Master router for Sweet July Skin's Operations Intelligence sub-system — covering
  purchase-to-pay, position-keeping, S&OP, freight, and DTC fulfillment.
...
oc3pl-order-manager; international outbound DTC consumer parcels — declaration
accuracy, DDP-vs-DDU posture per market, regulatory filing oversight (CNF for
Canada, CPNP for EU). Sample triggers: "where's the HCT shipment," "ETA on
Vegelabs," "what's stuck in customs," "draft an ASN for Ulta," "FedEx lost the
order — escalate," "why is this Canada order held," "CBSA refused our shipment,"
"set up DDP for Canada."
...
| Anything about international DTC parcels — Canada, EU, UK, AU — CBSA refusals, customer-pays-duty complaints, CNF/CPNP filings, DDP setup | logistics-manager |
...
- `references/sop-catalog.md` — Ops's own ratified SOP catalog (SKN-OPS-010,
  ...
  Logistics, and DTC/OC3PL. Confirmed 2026-08-06: no dedicated Ops umbrella
  skill is being built — this router is the settled home for Ops canonical
  data going forward, not a stand-in. The shared ratification/annual-review/
  numbering process it follows lives in `quality-manager/references/sop-program.md`.
...
System B (Quality Management) is live as of 2026-05-09 — router `sjs-quality-system`
covers six sub-skills (complaint-and-event-handler, capa-coordinator,
quality-lab-coordinator, batch-lifecycle-tracker, quality-manager,
quality-status-reporter). System 7 (Regulatory — regulatory-manager) is next
in the build queue. The Ops router picks up cross-system handoffs to System B
through the existing handshakes (oc3pl-order-manager → complaint-and-event-handler
for end-customer signal; inventory-manager → batch-lifecycle-tracker for
near-expiry quality calls; purchasing-manager ← quality-lab-coordinator for
vendor scorecard signals).
